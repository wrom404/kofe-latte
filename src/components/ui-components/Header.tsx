      ...
      <div className="flex gap-20">
        <div className="">
          <ul className="flex items-center gap-6 text-gray-100 text-lg cursor-pointer">
            <li className="hover:text-(--quaternary-color)">Home</li>
            <li>
              <DropdownMenu>
            ...
            <li className="hover:text-(--quaternary-color)">About Us</li>
            <li className="hover:text-(--quaternary-color)">Contact</li>
          </ul>
        </div>
